...
project = 'Shareorigin iOS User Guide'
...
latex_documents = [
  (master_doc, 'CentreStackiOSUserGuide.tex', 'Shareorigin iOS User Guide Documentation',
...
man_pages = [
    (master_doc, 'centrestackiosuserguide', 'Shareorigin iOS User Guide Documentation',
     [author], 1)
]
