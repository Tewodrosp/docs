...
latex_documents = [
  (master_doc, 'CentreStackInstallationGuide.tex', 'Shareorigin Installation Guide Documentation',
...
man_pages = [
    (master_doc, 'centreStackinstallationguide', 'Shareorigin Installation Guide Documentation',
     [author], 1)
]
